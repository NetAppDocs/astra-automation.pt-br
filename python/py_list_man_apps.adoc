...
summary: Você pode usar o script a seguir para listar os aplicativos da sua conta Astra. 
---
= Liste as aplicações
:hardbreaks:
:allow-uri-read: 
...
NOTE: link:../python/python_before.html["Antes de começar"]Consulte para obter um exemplo do arquivo de entrada JSON necessário.
